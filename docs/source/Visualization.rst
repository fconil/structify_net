...
- :func:`structureClasses.Rank_model::plot_matrix` for the matrix plot of a rank models
- :func:`structureClasses.Graph_generator::plot_proba_function` for the matrix plot of a Graph ER_generator
